// src/components/home/FeaturedWoodProducts.jsx
import { Link } from 'react-router-dom';
import { formatPrice } from '../../utils/formatPrice';
import ImageWithFallback from '../shared/ImageWithFallback';

function FeaturedWoodProducts({ items }) {
    ...
    <div className="w-full py-16" style={{ backgroundColor: '#f5f0e8' }}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400 text-sm mt-2">لوازم خانگی چوبی با کیفیت بالا</p>
        </div>
...
export default FeaturedWoodProducts;