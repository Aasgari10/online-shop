// src/components/auth/MobileRegister.jsx
...
function MobileRegister() {
  ...
  return (
    <div className="min-h-screen bg-[#E8DCC8] pr-1 pl-1 pb-12">
      {/* ===== هدر (بدون دکمه برگشت) ===== */}
      <div className="sticky top-0 z-30 bg-[#E8DCC8] px-4 py-1 flex items-center justify-center border-b border-gray-200/60">
      ...
      {/* ===== فرم ===== */}
      <div className="mx-1  bg-white  rounded-2xl shadow-sm border border-gray-200/60 p-2">
        <div className="text-center mb-5">
          ...
          <p className="text-sm text-gray-500">به خانواده HomeMart خوش آمدید</p>
        </div>
